...
@dynamicMemberLookup
public struct SwiftUINavigationTransitionTransform: Equatable {
...
extension OptionalWithDefault where Value == SwiftUINavigationTransitionTransform {
...
extension SwiftUINavigationTransitionTransform {
