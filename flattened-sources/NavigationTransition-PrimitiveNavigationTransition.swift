// import Animator - removed (flattened)
import UIKit
...
public protocol PrimitiveNavigationTransition {
	...
	///
	/// - Parameters:
	///   - Animator: The `SwiftUINavigationTransitionAnimator` object used for the transition. Attach animations or completion blocks to it.
	...
	func transition(with animator: any SwiftUINavigationTransitionAnimator, for operation: TransitionOperation, in context: any Context)
}
