...
/// Typealias for `SwiftUINavigationTransitionAnimator`. Useful for disambiguation.
public typealias _Animator = SwiftUINavigationTransitionAnimator
...
@objc public protocol SwiftUINavigationTransitionAnimator {
...
extension SwiftUINavigationTransitionAnimator where Self: UIViewImplicitlyAnimating {
	@MainActor
...
extension UIViewPropertyAnimator: SwiftUINavigationTransitionAnimator {}
